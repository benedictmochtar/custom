...
#     _inherit ='sale.order'
#
#     total_disc = fields.Monetary(string='Total Disc. 1', compute='_amount_all', default=0, store=True)
#     total_disc2 = fields.Monetary(string='Total Disc. 2', compute='_amount_all', default=0, store=True)
#
...
class SalesOrderLines(models.Model):
    ...
    def _compute_amount(self):
        ...
        """
        for line in self:
            price = line.price_unit * (1 - (line.discount or 0.0) / 100.0) * (1 - (line.disc2 or 0.0) / 100.0)
